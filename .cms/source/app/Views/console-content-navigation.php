...
if($location==='footer'){
    $menuEditor=['id'=>'footer-connect-navigation-form','location'=>'footer-connect','title'=>'Connect links','overline'=>'FOOTER · CONNECT COLUMN','description'=>'Additional calls to action displayed below the site contact details. Add, translate, reorder, hide or remove links here.','action'=>'Save Connect links','items'=>$connectItems];
    require __DIR__.'/console-content-navigation-editor.php';
}
?>
