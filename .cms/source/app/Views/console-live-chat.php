...
<section class="card sensecms-chat-shell" data-operator-chat data-conversation-id="<?= $escape($conversation['id'] ?? '') ?>">
    ...
    <div class="sensecms-chat-workspace">
        ...
        <div class="sensecms-chat-location" data-chat-visitor-location>
            <span>IP: <?= $escape($conversation['visitor_ip'] ?? 'Not recorded') ?></span>
            <span>Country: <?= $escape(\App\Core\IpCountry::name($conversation['visitor_country'] ?? null)) ?><?= !empty($conversation['visitor_country']) ? ' (' . $escape($conversation['visitor_country']) . ')' : '' ?> · approximate</span>
