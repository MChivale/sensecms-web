...
final class LicenseService
{
    ...
    {
        if (!in_array($broker,['https://www.sensecms.com/api/social/meta/v1','https://www.sensecms.com/api/social/x/v1','https://www.sensecms.com/api/social/linkedin/v1','https://www.sensecms.com/api/social/bluesky/v1','https://www.sensecms.com/api/social/pinterest/v1','https://www.sensecms.com/api/social/tiktok/v1','https://www.sensecms.com/api/social/youtube/v1'],true)) throw new LicenseException('Unexpected social connection service.');
        $record=$this->validated($domain);
        try { return ['Authorization: Bearer '.$record['key'],'X-SenseCMS-Domain: '.$record['domain']]; }
        finally { sodium_memzero($record['key']); }
    }
