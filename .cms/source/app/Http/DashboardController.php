...
final class DashboardController extends Controller
{
    ...
    public function savePost(): never
    {
        ...
        try{
            ...
            $input=['id'=>$id,'author_id'=>$this->auth->id(),'facility_id'=>$facility,'assigned_user_id'=>filter_input(INPUT_POST,'assigned_user_id',FILTER_VALIDATE_INT)?:null,'editorial_note'=>(string)($_POST['editorial_note']??''),'category_id'=>filter_input(INPUT_POST,'category_id',FILTER_VALIDATE_INT)?:null,'featured_media_id'=>filter_input(INPUT_POST,'featured_media_id',FILTER_VALIDATE_INT)?:null,'audio_media_id'=>filter_input(INPUT_POST,'audio_media_id',FILTER_VALIDATE_INT)?:null,'video_media_id'=>filter_input(INPUT_POST,'video_media_id',FILTER_VALIDATE_INT)?:null,'tags'=>$tags,'status'=>$status,'published_at'=>$publishedAt];$saved=$this->cms->savePost($input,$translations,$this->auth->id()??0);
