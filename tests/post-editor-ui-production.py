...
try:
    markers=(b'data-post-editor',b'data-post-rich-editor',b'data-sidebar-section="publication"',b'data-sidebar-section="media"',b'Media & distribution',b'featured_media_id',b'audio_media_id',b'video_media_id',b'data-post-tags',b'data-media-picker-search',b'data-media-picker-folders',b'data-media-picker-upload',b'data-media-folder-create',b'/theme/sensecms-content-management.css?v=20260920-post-editor-3',b'/theme/sensecms-editor-workflow.js?v=20260920-post-editor-2',b'/assets/lib/quill/quill.js?v=2.0.3',b'/theme/sensecms-post-editor.js?v=20260920-3',b'/extension-assets/addon/social-publishing/editor.js?v=0.5.2')
    ...
    status,script,headers=request('/theme/sensecms-post-editor.js?v=20260920-3');assert status==200 and b'sensecms:post-media-change' in script and b'sensecms-tag-chip' in script and b'data-media-folder-save' in script and b'sensecms:content-ready' in script and 'javascript' in headers.get_content_type()
