...
try:
    markers=(b'data-post-editor',b'data-post-rich-editor',b'data-sidebar-section="publication"',b'data-sidebar-section="ai"',b'data-post-ai-review',b'data-sidebar-section="media"',b'Media & distribution',b'featured_media_id',b'audio_media_id',b'video_media_id',b'data-post-tags',b'Include in Knowledge Base',b'name="ai_knowledge_enabled"',b'data-media-picker-search',b'data-media-picker-folders',b'data-media-picker-upload',b'data-media-folder-create',b'/theme/sensecms-content-management.css?v=20260921-knowledge-1',b'/theme/sensecms-editor-workflow.js?v=20260920-post-editor-2',b'/assets/lib/quill/quill.js?v=2.0.3',b'/theme/sensecms-post-editor.js?v=20260921-1',b'/theme/sensecms-post-ai.js?v=20260921-1',b'/extension-assets/addon/social-publishing/editor.js?v=0.5.2')
